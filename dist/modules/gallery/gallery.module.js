...
const gallery_item_entity_1 = require("./gallery-item.entity");
...
exports.GalleryModule = GalleryModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([gallery_item_entity_1.GalleryItem]), auth_module_1.AuthModule],
