...
const page_section_entity_1 = require("./page-section.entity");
...
exports.PageSectionsModule = PageSectionsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([page_section_entity_1.PageSection]), auth_module_1.AuthModule],
        controllers: [page_sections_controller_1.PageSectionsController],
        providers: [page_sections_service_1.PageSectionsService],
        exports: [page_sections_service_1.PageSectionsService],
    })
], PageSectionsModule);
